...
const AdminwhatsappaddViewer = {
    name : 'adminwhatsappadd-viewer',
    data() {
        return {
    ...
    methods: {
        ...
        {
            this.UserSupport.saveWhatsAppCampaign(this.campaign,(response)=>{
                if(response.s == 1)
                {
        ...
        getWhatsAppCampaign()
        {
            this.UserSupport.getWhatsAppCampaign(this.campaign,(response)=>{
                if(response.s == 1)
                {
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <button 
                            ...
                            ref="button"
                            class="btn btn-primary" @click="saveWhatsAppCampaign">
                            Guardar
                        </button>
                    </div>
                </div>
