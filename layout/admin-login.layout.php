...
<html lang="es">
    <head>
        ...
        <meta content="I am beauty Oil" name="author" />
    ...
    <body class="bg-light">
        ...
        <footer class="fixed-bottom w-100 text-center py-3 fw-semibold text-white">
            © <script> document.write(new Date().getFullYear()) </script>, made with <i class="fa fa-heart"></i> by <a href="https://www.iam.com.mx/" class="font-weight-bold text-white" target="_blank">IAM</a> for a better web.
        </footer>
    </body>
</html>