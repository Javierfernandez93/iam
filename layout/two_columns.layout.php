...
<html lang="es">
    ...
    <body>
        ...
        <footer class="fixed-bottom d-none w-100 text-center py-3 fw-semibold">
            © <script> document.write(new Date().getFullYear()) </script>, made with Love <i class="fa fa-heart"></i> by <a href="https://www.Iam.com/" class="font-weight-bold" target="_blank">Iam</a> for a better web.
        </footer>
    </body>
</html>