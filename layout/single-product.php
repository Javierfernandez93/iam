...
<head>
    ...
    <style>
        :root{
            --bg-primary-back: <?php echo DummieTrading\SystemVar::_getValue("backoffice_background_color_top_behivor");?>;
            --bg-primary-light: <?php echo DummieTrading\SystemVar::_getValue("backoffice_highlight_color_top_behivor");?>;
        }
    </style>
...
<body class="g-sidenav-show">
    ...
    <script src="../../src/js/alertCtrl.min.js?v=2.6.6" type="text/javascript"></script>
    ...
    <script src="../../src/js/cookie.min.js?v=2.6.6" type="text/javascript"></script>
